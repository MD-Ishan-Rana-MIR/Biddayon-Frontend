...
const BlogPageBanner = () => {
  return (
    <div className="bgGradientColor min-h-screen flex items-center py-10">
      <div className="max-w-7xl mx-auto px-4 w-full  ">
        <div className="flex flex-col-reverse md:flex-row items-start justify-between gap-6">
          ...
          <div className="w-full md:w-1/2">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl text-white font-bold mt-4 leading-tight">
