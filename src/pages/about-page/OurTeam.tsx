    ...
    return (
        <div className="mt-32">
            ...
            <div className="text-center">
                ...
                <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold mt-3 bg-gradient-to-r from-[#8723d3] to-[#D7277D] bg-clip-text text-transparent">আমাদের দক্ষ টিম সদস্যরা</h1>
            ...
            {/* team member */}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 mt-14 md:px-32 px-5">
                <div className="relative w-fit group hover:scale-[101%] hover:translate-y-1 duration-300 transition-all">
